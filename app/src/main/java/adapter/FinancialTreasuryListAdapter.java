...
public abstract class FinancialTreasuryListAdapter<T> extends BaseAdapter {
    ...
    public FinancialTreasuryListAdapter(Context context, int itemID) {
    ...
    public FinancialTreasuryListAdapter(Context context, XListView xListView, int itemID) {
        this.mContext = context;
    ...
    public FinancialTreasuryListAdapter(Context context, GridView gridView, int itemID) {
        this.mContext = context;
