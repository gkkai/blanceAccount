...
public abstract class AccountYearListAdapter<T> extends BaseAdapter {
    ...
    public AccountYearListAdapter(Context context, int itemID) {
    ...
    public AccountYearListAdapter(Context context, XListView xListView, int itemID) {
        this.mContext = context;
    ...
    public AccountYearListAdapter(Context context, GridView gridView, int itemID) {
        this.mContext = context;
