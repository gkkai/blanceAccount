...
public abstract class AccountProjectListAdapter<T> extends BaseAdapter {
    ...
    public AccountProjectListAdapter(Context context, int itemID) {
    ...
    public AccountProjectListAdapter(Context context, XListView xListView, int itemID) {
        this.mContext = context;
    ...
    public AccountProjectListAdapter(Context context, GridView gridView, int itemID) {
        this.mContext = context;
